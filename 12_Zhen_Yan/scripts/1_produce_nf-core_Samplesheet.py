#!/usr/bin/env python3
# 运行方法：cd /home/gao/projects_2026H2/12_Zhen_Yan/scripts && conda run -n regular_bioinfo python 1_produce_nf-core_Samplesheet.py
import pandas as pd
import glob
import os

fastq_base_dir = "/Work_bio/dropbox/Dropbox_Data/Quote_06092601_Zhen_Yan/"
original_sheet = "../Sample_Sheet_Zhen_Yan.xlsx"
