...
# 运行方法: cd /home/gao/projects_2026H2/12_Zhen_Yan/scripts && Rscript 6_generate_research_report.R
#
...
# ================= 1. 路径设置 =================
setwd("/home/gao/projects_2026H2/12_Zhen_Yan/scripts/")
...
report <- c(
  paste0("# Human Bulk RNA-seq Analysis Report — Zhen Yan Project"),
  "",
  ...
  "| Group | Samples | Role |",
  "| :--- | :---: | :---: |",
  paste0("| CTRL | CTRL_1, CTRL_2, CTRL_3, CTRL_4 | Control |"),
  paste0("| CHD3 | CHD3_1, CHD3_2, CHD3_3, CHD3_4 | Treatment 1 |"),
  paste0("| ASHL | ASHL_1, ASHL_2, ASHL_3 | Treatment 2 |"),
  "",
  paste0("Total samples: **", nrow(meta), "**  |  ",
         "Comparisons: CHD3 vs CTRL, ASHL vs CTRL"),
  "",
      ...
      lines <- c(lines,
        paste0("- **", comp_name, "**: ", s$total, " DEGs identified. ",
               if (s$up > s$down) paste0("Predominantly upregulated (", s$up, " up vs ", s$down, " down), ",
                 "suggesting activation of transcriptional programs relative to control.")
