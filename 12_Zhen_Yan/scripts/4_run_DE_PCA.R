...
# 运行方法: cd /home/gao/projects_2026H2/12_Zhen_Yan/scripts && Rscript 4_run_DE_PCA.R
#
# 分析设计: CTRL = 对照组 (client note: "control vs other groups, 参考客户之前的分析要求")
#   CHD3 vs CTRL, ASHL vs CTRL
...
META_FILE  <- "../Sample_Sheet_Zhen_Yan.xlsx"
...
meta <- meta_raw %>%
  transmute(
    ...
    Group     = factor(as.character(Group), levels = c("CTRL", "CHD3", "ASHL"))  # CTRL = 对照组
  )
...
# ================= 8. 差异表达分析: CHD3 vs CTRL, ASHL vs CTRL =================
