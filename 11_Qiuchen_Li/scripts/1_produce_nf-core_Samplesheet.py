#!/usr/bin/env python3
# 运行方法：cd /home/gao/projects_2026H2/11_Qiuchen_Li/scripts && conda run -n regular_bioinfo python 1_produce_nf-core_Samplesheet.py
import pandas as pd
import glob
import os

fastq_base_dir = "/Work_bio/dropbox/Dropbox_Data/Qiuchen/"
original_sheet = "../Sample_Sheet_Qiuchen_Li.xlsx"
