...
3. **CRISPR edits confirmed; tumor lineages resolved.** Brca1 and Pten knockout are confirmed in B1TP; Pten knockout (Brca1 wild-type) in B2TP. Tumors 1 and 2 derive from the **B1TP (Brca1+Pten)** lineage. Tumor 3 is an exception requiring follow-up (see §7).
