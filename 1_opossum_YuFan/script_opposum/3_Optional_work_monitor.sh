# 1. 查看实际运行的样本列表
cat /Work_bio/gao/projects/2026_Item9_gc/scripts/nf_core_samplesheet.csv

# 2. 统计 STAR_ALIGN 任务总数
grep "STAR_ALIGN" /Work_bio/gao/projects/2026_Item9_gc/scripts/.nextflow.log | grep -c "Submitted process"

# 3. 查看已完成和运行中的任务
grep "STAR_ALIGN" /Work_bio/gao/projects/2026_Item9_gc/scripts/.nextflow.log | grep -E "COMPLETED|RUNNING" | wc -l


# 1. 统计 samplesheet 中的样本数
tail -n +2 /Work_bio/gao/projects/2026_Item9_gc/scripts/nf_core_samplesheet.csv | wc -l
# 预期输出: 34

# 2. 查看哪些样本的 STAR_ALIGN 已完成
grep "STAR_ALIGN" /Work_bio/gao/projects/2026_Item9_gc/scripts/.nextflow.log | \
  grep "COMPLETED" | \
...
# # 1. 定位 Wh2b 最新的工作目录
# WH2B_DIR=$(find /Work_bio/gao/projects/2026_Item9_gc/scripts/work -maxdepth 3 -name ".command.run" -exec grep -l "Wh2b" {} + | xargs ls -td | head -n 1 | xargs dirname)
...
for sample in WTS4_1 WTS4_2 WTS4_4 WTS4_5 WhS4_1 WhS4_4 WhS4_5 WhS4_9 Wh1a Wh1b Wh1c Wh1d Wh2a Wh2b Wh2c Wh2d Wh3a Wh3b Wh3c Wh3d Wh4a Wh4b Wh4c Wh4d Wh5a Wh5b Wh5c Wh5d Wh6a Wh6b Wh6c Wh6d TperMix TtriMix; do
  dir=$(find /Work_bio/gao/projects/2026_Item9_gc/scripts/work -name ".command.run" -exec grep -l "$sample" {} + 2>/dev/null | head -1 | xargs dirname)
...
grep "STAR_ALIGN.*RUNNING" /Work_bio/gao/projects/2026_Item9_gc/scripts/.nextflow.log | tail -5
...
# 找到 WTS4_1 的工作目录
WTS4_1_DIR=$(find /Work_bio/gao/projects/2026_Item9_gc/scripts/work -name ".command.run" -exec grep -l "WTS4_1" {} + | xargs ls -td | head -1 | xargs dirname)
echo $WTS4_1_DIR
...
tail -n 3 /Work_bio/gao/projects/2026_Item9_gc/scripts/work/b0/b6ed769b0abaddef055149e3eaadca/Log.progress.out


# WTS4_1 的 STAR 工作目录（根据您之前日志）
WTS4_1_STAR_DIR="/Work_bio/gao/projects/2026_Item9_gc/scripts/work/b0/b6ed769b0abaddef055149e3eaadca/"
