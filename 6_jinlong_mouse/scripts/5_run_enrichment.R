...
ENR_DIR  <- file.path(DATA_DIR, "Enrichment_Standard")
...
cat("\n🎉 Standard enrichment analyses complete. Results:", ENR_DIR, "\n")
cat("Next step: run 5b_run_custom_pathway.R for StemCell / CellDiff / Notch analyses.\n")
